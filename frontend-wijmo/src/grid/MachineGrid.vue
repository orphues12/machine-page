<template>
    <div style="max-height:80vh;">
        ...
        >
            <wj-flex-grid-filter :filterColumns="['machineCode','machineName','machineSize','machineModel',]" />
            <wj-flex-grid-column binding="index" header="Number" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="machineCode" header="machineCode" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="machineName" header="machineName" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="machineSize" header="machineSize" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="machineModel" header="machineModel" width="2*" :isReadOnly="true" align="center" />
        </wj-flex-grid>
